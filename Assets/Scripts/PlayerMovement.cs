...
public class PlayerMovement : MonoBehaviour
{
    ...
    {
        if (Input.GetKey(KeyCode.D) && isWallRight && !grounded)
        {
            StartWallRun();
        }

        if(Input.GetKey(KeyCode.A) && isWallLeft && !grounded)
        {
            StartWallRun();
        }
    }
    ...
    private void StartWallRun()
    {
        ...
        {
            //Give forward momentum on the wall
    ...
    private void Look()
    {
        ...
        //Tilt the camera back when done
